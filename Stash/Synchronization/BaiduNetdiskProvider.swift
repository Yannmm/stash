...
extension Synchronizer {
    final class BaiduDiskSyncProvider: SyncProvider {
        let method: Method = .baiduDisk
        let displayName = Method.baiduDisk.displayName
        ...
        func upload(payloadData: Data, metadata: Metadata, previousRevision: String?) async throws -> UploadResponse {
            ...
            return UploadResponse(providerRevision: metadata.revision, metadata: metadata)
        }
...
extension Synchronizer.BaiduDiskSyncProvider {
